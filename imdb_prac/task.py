...
def main(args):
    ...
    def lmbda(epoch): return epoch/args.warm_ep
    ...
    train_pipe.amp_training(args.ep, args.save_step, model_outputs,
                            get_classMetrics, warm_step=args.warm_ep, per_ep_eval=3)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr", default=1e-3, type=float,
                        help="Init learning rate for update model weight.Default 1e-3.")
    parser.add_argument("--warm_ep", default=6, type=int,
                        help="Gradually increase small lr over a few epoch until equal to init lr.")
    parser.add_argument("--ep", default=12, type=int,
                        help="Total epoch nums for train.Default 12.")
    parser.add_argument("--batch_size", default=64, type=int, help="The batchworker data num that iter in one epoch. \
                                                             Default 64")
    parser.add_argument("--workers", default=4, type=int,
                        help="Set process num for generate data.Default 4.")
    parser.add_argument("--save_step", default=4, type=int,
                        help="Save model to gcloud in every N epochs.Default 4.")

    parser.add_argument("--max_token_num", default=30, type=int,
                        help="The max token num in each sent.Default 30.")
    parser.add_argument("--max_sentN", default=3, type=int,
                        help="The max sents num for input text.Default 3.")
    parser.add_argument("--embed_dim", default=256, type=int,
                        help="The embed dim for input token.Default 256.")
    parser.add_argument("--ent_embed", default=30, type=int,
                        help="The embed dim for entity.Default 30.")
    parser.add_argument("--hid_dim", default=256, type=int,
                        help="The hid dim for rnn_layer.Default 256.")
    parser.add_argument("--output_dim", default=1, type=int,
                        help="Model output class num.")
    parser.add_argument("--n_layers", default=2, type=int,
                        help="The nums of FFN layer that in model.Default 2")
    parser.add_argument("--pad_idx", default=0, type=int,
                        help="The token/ent index for zero-value vector in embed matrix.Default 0")
